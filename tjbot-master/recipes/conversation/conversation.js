  ...
  if (str.toLowerCase().indexOf(attentionWord.toLowerCase()) >= 0) {
    ...
    conversation.message({
      ...
      if (err) {
        ...
        {
        floor_no = response.entities[0].value.charAt(0) + "000";
        console.log(floor_no);
        
   var request = require("request");

var options = { method: 'POST',
    url: 'https://api.kone.com/api/building/9990000508/call',
    headers: 
    { accept: 'application/vnd.collection+json',
     'content-type': 'application/vnd.collection+json',
     'x-ibm-client-secret': 'bK2wT8iY3fY6uP3uR8xL2dY0mB2rY5iK6uA0vN8iU1aM7iR7kI',
     'x-ibm-client-id': '478539e8-0b3d-41dc-a877-740417eb04b5' },
    body: '{ "template": {"data":[  {   "name":"sourceAreaId",      "value": "area:9990000508:1000"}, {   "name":"destinationAreaId", "value": "area:9990000508:2000"} ]   } }'};
